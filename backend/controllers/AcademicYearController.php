...
class AcademicYearController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if($_POST['AcademicYear']['status']==$model::ACTIVE) {
                AcademicYear::updateAll(['status' => $model::INACTIVE]);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if(($_POST['AcademicYear']['status']==$model::ACTIVE)) {
                ...
                Yii::$app->session->setFlash('danger', 'You need to assign first default year to another year in academic years list which are in active');
                return $this->redirect(['index']);
            }
